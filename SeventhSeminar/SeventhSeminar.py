...
def CheckRythm(word):
	vowels = 0
	glossary = "aoeiuyаоуыэеёиюя"
	for char in word.lower():
		if char == " " and vowels%2 == 1:
			return print("Пам парам", vowels)
		for i in glossary:
			if i == char:
				vowels +=1
	return print("Парам пам-пам", vowels)

#chant = input("Введи кричалку: ")

#chant = "пара-ра-рам рам-пам-папам па-ра-па-да"		
#chant = "пAр-ра-рам рам-пам-папам па-ра-па-да"
chant = "Gagagga gAgga gagg gaagggag"
CheckRythm(chant)
